...
// Firebase Error Handling And Writing Data At Specifed Path************************************************
  if (Firebase.getInt(firebaseData, "/dr_umair_counter", val) && Firebase.getString(firebaseData, "/dr_umair_time", global_timestamp)) {    // On successful Write operation, function returns 1  
