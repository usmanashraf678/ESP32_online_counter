...
// Wifi config
const char* wifi_ssid = "Umer rice mill";             // SSID
const char* wifi_password = "Premier1";         // WIFI
...
const char* apiKeyIn = "6hSrkXae07wriJdU5PVnSYjGcTh4w3KU";      // API KEY IN, example: FALOAPPKH17ZR4Q23A8U9W0XPJL0F6OG
